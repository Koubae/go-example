...
var (
	...
	DatabaseWritePathError       = errors.New("DATABASE_WRITE_PATH_ERROR: Error while writing database path")
	DatabaseWritePathSubDirError = errors.New("DATABASE_WRITE_PATH_SUB_DIR_ERROR: Error while writing database sub directories")
